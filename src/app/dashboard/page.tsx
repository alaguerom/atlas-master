  ...
  if (isLoading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-blue-500 via-blue-600 to-blue-900 text-white">
        <p className="text-xl font-bold">Cargando Atlas Master...</p>
      </main>
    );
  }
      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <section className="mt-6 rounded-3xl border border-white/20 bg-blue-950/20 p-6 text-center shadow-xl backdrop-blur-md sm:p-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-blue-100 sm:text-lg">
            Elige un modo de juego, reconoce países y consigue puntos mientras
            completas tu atlas.
          </p>
        </section>
        ...
        >
          <div className="rounded-2xl border border-white/20 bg-white/10 p-4 text-center">
            ...
            <p className="mt-1 text-sm text-blue-100">Partidas</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-white/10 p-4 text-center">
            <p className="text-3xl font-black">0</p>
            <p className="mt-1 text-sm text-blue-100">Puntos</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-white/10 p-4 text-center">
            <p className="text-3xl font-black">0%</p>
            <p className="mt-1 text-sm text-blue-100">Aciertos</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-white/10 p-4 text-center">
            <p className="text-3xl font-black">1</p>
            <p className="mt-1 text-sm text-blue-100">Nivel</p>
          </div>
        </section>
        ...
        <section className="mt-8">
          <div className="mb-4">
            ...
            <p className="mt-1 text-blue-100">
              Comenzaremos desarrollando el modo Banderas.
            </p>
          </div>

          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {gameModes.map((mode) => {
              const isFirstMode = mode.name === "Banderas";
